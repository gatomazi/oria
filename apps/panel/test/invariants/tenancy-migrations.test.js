...
const DEPOIS_DA_FASE1 = 31; // 21 (linha acima) +8 do Gerador de Criativos, renumeradas na integração para depois de
...
// +1 de Clientes/RFM (0043, origem/regra dos segmentos vindos de Clientes; renumerada depois do catalog sync)
