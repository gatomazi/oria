...
test('negative control · cobre as classes críticas das Fases 0 a 5c e da construção da Fase 7', () => {
  assert.deepEqual(
    ...
    ['audit/sujeito', 'auth', 'auth/csrf', 'auth/fixation', 'auth/login-tenant', 'auth/revogacao',
      ...
      'integracoes/google-ads-sem-developer-token', 'integracoes/instagram-finge-conexao', 'integracoes/leitura-falha-vira-nao-configurado',
      'integracoes/plataforma-ausente-vira-nao-configurado', 'integracoes/resolver-global', 'integracoes/sem-plano-vira-conectavel',
      'integracoes/token-de-outra-org', 'integracoes/webhook-adiado-rebaixa-ink', 'jobs/contexto', 'jobs/lease-ignorado', 'meta/conexao-com-problema-vira-saudavel', 'meta/oauth-aceita-store-arbitraria',
