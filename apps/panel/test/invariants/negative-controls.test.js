...
test('negative control · cobre as classes críticas das Fases 0 a 5c e da construção da Fase 7', () => {
  assert.deepEqual(
    ...
    ['audit/sujeito', 'auth', 'auth/csrf', 'auth/fixation', 'auth/login-tenant', 'auth/revogacao',
      ...
      'onboarding/segunda-fonte', 'operacao/auditoria-com-id-nulo', 'operacao/campanha-sem-store-id',
      'operacao/escopo-exige-chave-legada', 'operacao/job-ignora-store-nativa', 'operacao/promocoes-exigem-chave-legada',
      ...
      'whatsapp/es-origem-frouxa', 'whatsapp/es-sem-posse-do-recurso', 'whatsapp/es-state-nao-amarrado',
      'whatsapp/health-como-remetente', 'whatsapp/par-cruzado', 'whatsapp/ref-forjada', 'whatsapp/remetente-global',
      'whatsapp/repasse-boot-inferido', 'whatsapp/repasse-boot-so-avisa', 'whatsapp/repasse-rota-legada',
      'whatsapp/repasse-segredo-na-query', 'whatsapp/repasse-sem-segredo', 'whatsapp/token-serializavel',
      'whatsapp/tolerancia-compara-query', 'whatsapp/tolerancia-sem-assinatura', 'whatsapp/tolerancia-sem-flag']
  );
});
