...
test('negative control · cobre as classes críticas das Fases 0 a 5c e da construção da Fase 7', () => {
  assert.deepEqual(
    ...
    ['audit/sujeito', 'auth', 'auth/csrf', 'auth/fixation', 'auth/login-tenant', 'auth/revogacao',
      ...
      'entitlement', 'entitlement/app-config-como-fonte', 'entitlement/ausencia', 'fase6/bypass-interno', 'financeiro/despesas-exige-loja-legada', 'http/async-sem-rede', 'http/erro-vaza-stack', 'integracoes/desconectar-cruzado', 'integracoes/env-global',
      'integracoes/resolver-global', 'integracoes/token-de-outra-org', 'jobs/contexto', 'jobs/lease-ignorado', 'midia/atribuicao-canonica-ausente', 'midia/conta-de-outra-organization',
