...
test('negative control · cobre as classes críticas das Fases 0 a 5c e da construção da Fase 7', () => {
  assert.deepEqual(
    ...
    ['audit/sujeito', 'auth', 'auth/csrf', 'auth/fixation', 'auth/login-tenant', 'auth/revogacao',
      'catalogo/paginacao-ignora-page', 'clientes/cadastro-cache-sem-store', 'clientes/cadastro-duplica-comprador', 'clientes/chave-da-store-ausente', 'clientes/chave-repetida-na-lista', 'clientes/paginacao-ignora-pagina', 'connector/chamador-exige-loja-legada', 'connector/leitura-por-loja', 'connector/save-sem-atomicidade',
